...
Spree::PermittedAttributes.user_attributes.push :first_name, :last_name, :dob, :city, :state, :zip_code, :address, :seller,:shop_name,:phone,:allowPickUp,:MadeInIndia,:land_line,:mobile2
attachment_config = {
    s3_credentials: {
